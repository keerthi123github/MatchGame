...
class MatchGame extends Component {
  ...
  clearSetInterval = () => clearInterval(this.timerId)

  componentWillUnmount = () => this.clearSetInterval()
  ...
  decreaseSeconds = () => {
    ...
    if (displaySecs === 0) {
      ...
      this.setState(prevState => ({
        displaySecs: prevState.displaySecs - 1,
      }))
    }
  }
  ...
  onClickThumbnailImg = imageUrl => {
    ...
    const imgListIndex = Math.floor(Math.random() * imagesList.length)
    const randomImgUrl = imagesList[imgListIndex].imageUrl
    this.setState({displayImgUrl: randomImgUrl})
  }
  ...
  render() {
    ...
    return (
      <div>
        <NavBar key="navbar" score={score} displaySecs={displaySecs} />
        <div className="app-container">
          {isGameRunning ? (
            ...
            <div className="display-game-container">
